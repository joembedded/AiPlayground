...
export let persona = null; // Persona-Name für KI z.B. vilo
...
export async function speakText(inputText, cache = false) {
    if (isProcessing) {
        return;
    }
...
export async function talkWithServer(text, persona, concerningMessage = null) {
    const payload = {
